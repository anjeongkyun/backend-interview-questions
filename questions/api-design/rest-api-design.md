...
설계 취향이 아니라 **판단 근거**가 있는지 봅니다. 정답이 없는 영역이라 이유를 못 대면 취향으로 끝납니다.
...
[![문제로 풀어보기](../../assets/foundry-practice.svg)](https://learn-foundry.app/guides/api-design/rest-api-design?utm_source=github&utm_medium=repo&utm_campaign=oss_questions)
